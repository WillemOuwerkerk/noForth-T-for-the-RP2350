...
The folders contain a dual and single CDC-driver using RP2350 assembly too.
...
**In more detail:**
    ...
    • The host issues a USB bus reset command to the new device
	    ◦ The device gives itself device address 0
...
**Add the CDC driver:**
    ...
    2) Load the file: USB-XS-005hilevel-RP2350.f
