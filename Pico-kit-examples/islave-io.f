...
I2C registers from page  1008 ff.
...
: I2C-READ?     ( -- 0|x )  020 'i2c 2C bit** ; \ I2C read request?
: I2C-WRITE?    ( -- 0|x )  008 'i2c 70 bit** ; \ I2C write request?
: I2C-BUSY?     ( -- 0|x )  100 'i2c 2C bit** ; \ I2C busy?
...
: SLAVE         ( -- )          \ Send & receive I2C data on MY address
    ...
    begin
        i2c-read? if                    \ Read request?
            S? FF and  i2c-data !       \ Yes , send data
            begin  i2c-busy? 0= until   \ Transmit done?
