...
Flash memory map:
    ...
    1008,1000   = Start of noforth system-2 ( FREEZE2 & COLD2)
    1010,1000   = Start of library ( LIB-ORG )
    101D,26C9   = Used part of library ( LIBHERE )
    1020,0000   = Limit for library
    1040,0000   = End of smallest Flash memory ( max = 1100,0000 )
*)
